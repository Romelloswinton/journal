...
import { Smile, Book, Dumbbell, Users, Music, Home, Zap } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Input } from "@/components/ui/input"
import { Label } from "@/components/ui/label"
import { RadioGroup, RadioGroupItem } from "@/components/ui/radio-group"
import { CreateIngredientInput } from "@/lib/services/ingredientService"

interface IngredientFormProps {
  onCancel: () => void
  onSubmit: (ingredient: CreateIngredientInput) => void
}
...
export default function IngredientForm({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!ingredientName || !ingredientCategory) return
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2 mt-2">
          ...
          <Button
            type="button"
            variant={ingredientCategory === "learning" ? "default" : "outline"}
            className={`justify-start ${
          ...
          <Button
            type="button"
            variant={ingredientCategory === "exercise" ? "default" : "outline"}
            className={`justify-start ${
      ...
      <div>
        <Label htmlFor="ingredientFrequency" className="text-sm font-medium">
          How often?
        </Label>
        <RadioGroup
      ...
      <div>
        <Label htmlFor="ingredientImportance" className="text-sm font-medium">
      ...
      <div className="flex gap-4 mt-6">
        ...
        <Button
          type="submit"
          disabled={!ingredientName || !ingredientCategory || isSubmitting}
